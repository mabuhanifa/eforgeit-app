    ...
    <header className="sticky top-0 z-50 w-full border-b border-gray-200 bg-white/95 backdrop-blur supports-[backdrop-filter]:bg-white/60 dark:border-gray-800 dark:bg-gray-950/95">
      <div className="container flex h-14 max-w-screen-2xl items-center">
        ...
        <div className="flex flex-1 items-center justify-end space-x-2">
          <ThemeToggle />
          <button
            className="inline-flex items-center justify-center rounded-md p-2 text-gray-500 hover:text-gray-700 hover:bg-gray-100 md:hidden dark:text-gray-400 dark:hover:text-gray-200 dark:hover:bg-gray-800"
